...
public class CharacterEngine : MonoBehaviour
{
    ...
    private void CheckifRunningAndLocalScale()
    {
        ...
        {
            owner.AnimatorController.CharacterGraphics.localScale = new Vector2(owner.Controller2D.Collisions.FaceDirection > 0 ? -1 : 1, 1);
    ...
    public void OnJumpInputDown()
    {
        if (owner.Controller2D.Collisions.Below)
        {
            ...
            Debug.LogError("Play Jump sound here!");
    ...
    private IEnumerator IDash()
    {
        ...
        Debug.LogError("Play Dash sound here!");
    ...
    private IEnumerator IInvincibility(float invincibilityDuration, float flashSpeed)
    {
        ...
        owner.ChangePlayerState(CHARACTER_STATE.NORMAL);
        invincibilityCoroutine = null;
    }
    private IEnumerator IFlashSpriteRenderer(float flashSpeed)
    {
        while (owner.CurrentState.Equals(CHARACTER_STATE.INVINCIBILITY))
        {
    ...
    private IEnumerator IRespawn(Vector2 spawnPoint, float respawnDelay)
    {
        ...
        Debug.LogError("Play Respawn Sound here!");
        ...
        owner.ChangePlayerState(CHARACTER_STATE.INVINCIBILITY);
