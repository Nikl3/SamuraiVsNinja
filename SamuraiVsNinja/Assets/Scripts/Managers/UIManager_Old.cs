...
public class UIManager_Old : Singelton<UIManager_Old>
{
	#region PROPERTIES
	...
	private void Update()
	{
		OnStartButtonDown(GameManager.Instance.CurrentGameState);
	}
	...
	private void OnStartButtonDown(GAME_STATE_OLD currentGameState)
	{
	...
	public void SetMainMenuUI()
	{
        ...
        Debug.LogError("Stop LevelTheme sound here!");
        //EventManager.Instance.PostEvent("Victory", EventAction.StopSound);
        Debug.LogError("Stop Victory sound here!");
        //EventManager.Instance.PostEvent("MenuTheme");
        Debug.LogError("Start Menu Theme sound here!");   
    }
    public void SetLevelUI()
	{
        ...
        Debug.LogError("Start LevelTheme sound here!");
    }
